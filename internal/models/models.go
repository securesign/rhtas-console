...
// Valid indicates whether the value is a known member of the ArtifactIdentitySource enum.
func (e ArtifactIdentitySource) Valid() bool {
	switch e {
	case Issuer:
		return true
	case Other:
...
// Valid indicates whether the value is a known member of the ArtifactSummaryViewOverallStatus enum.
func (e ArtifactSummaryViewOverallStatus) Valid() bool {
	switch e {
	case ArtifactSummaryViewOverallStatusFailed:
		return true
	case ArtifactSummaryViewOverallStatusUnsigned:
		return true
	case ArtifactSummaryViewOverallStatusVerified:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the CertificateRole enum.
func (e CertificateRole) Valid() bool {
	switch e {
	case CertificateRoleIntermediate:
		return true
	case CertificateRoleLeaf:
		return true
	case CertificateRoleRoot:
		return true
	case CertificateRoleUnknown:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the TimeCoherenceSummaryStatus enum.
func (e TimeCoherenceSummaryStatus) Valid() bool {
	switch e {
	case TimeCoherenceSummaryStatusError:
		return true
	case TimeCoherenceSummaryStatusOk:
		return true
	case TimeCoherenceSummaryStatusUnknown:
		return true
	case TimeCoherenceSummaryStatusWarning:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AttestationStatusAttestation enum.
func (e AttestationStatusAttestation) Valid() bool {
	switch e {
	case AttestationStatusAttestationFailed:
		return true
	case AttestationStatusAttestationVerified:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AttestationStatusChain enum.
func (e AttestationStatusChain) Valid() bool {
	switch e {
	case AttestationStatusChainFailed:
		return true
	case AttestationStatusChainVerified:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the AttestationStatusRekor enum.
func (e AttestationStatusRekor) Valid() bool {
	switch e {
	case AttestationStatusRekorFailed:
		return true
	case AttestationStatusRekorVerified:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SignatureStatusChain enum.
func (e SignatureStatusChain) Valid() bool {
	switch e {
	case SignatureStatusChainFailed:
		return true
	case SignatureStatusChainVerified:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SignatureStatusRekor enum.
func (e SignatureStatusRekor) Valid() bool {
	switch e {
	case SignatureStatusRekorFailed:
		return true
	case SignatureStatusRekorVerified:
		return true
	default:
		return false
	}
...
// Valid indicates whether the value is a known member of the SignatureStatusSignature enum.
func (e SignatureStatusSignature) Valid() bool {
	switch e {
	case Failed:
		return true
	case Verified:
...
type TimeCoherenceSummary struct {
	MaxIntegratedTime *time.Time                 `json:"maxIntegratedTime,omitempty"`
	MinIntegratedTime *time.Time                 `json:"minIntegratedTime,omitempty"`
...
type VerifyArtifactRequest struct {
	...
	ExpectedOIDIssuer *string `json:"expectedOIDIssuer,omitempty"`

	// ExpectedOIDIssuerRegex Regular expression that the OIDC issuer must match, if exact match is not desired.
	ExpectedOIDIssuerRegex *string `json:"expectedOIDIssuerRegex,omitempty"`
...
func (siw *ServerInterfaceWrapper) GetApiV1ArtifactsImage(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, true, "uri", r.URL.Query(), &params.Uri, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetApiV1ArtifactsArtifactPolicies(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindStyledParameterWithOptions("simple", "artifact", chi.URLParam(r, "artifact"), &artifact, runtime.BindStyledParameterOptions{ParamLocation: runtime.ParamLocationPath, Explode: false, Required: true, Type: "string", Format: ""})
	if err != nil {
...
func (siw *ServerInterfaceWrapper) GetApiV1TrustConfig(w http.ResponseWriter, r *http.Request) {
	...
	err = runtime.BindQueryParameterWithOptions("form", true, false, "tufRepositoryUrl", r.URL.Query(), &params.TufRepositoryUrl, runtime.BindQueryParameterOptions{Type: "string", Format: ""})
	if err != nil {
